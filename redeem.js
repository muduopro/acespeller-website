...
const i18n = {
  'zh-HK': {
    ...
    ptaConsentCheckbox: '本人已閱讀上述說明，並同意提供相關資料予學校。',
  ...
  'zh-CN': {
    ...
    ptaConsentCheckbox: '本人已阅读上述说明，並同意提供相关资料予学校。',
  ...
  'en-US': {
    ...
    ptaConsentCheckbox: 'I have read the above and consent to sharing my data with the school.',
